...
> **Superseded.** This is the shot list for the Pass 01 prototype, preserved
> alongside its build in `src-iphone/`. The live product is Field Guide 001;
> its checklist is `MEDIA-CHECKLIST.md` at the repository root.
